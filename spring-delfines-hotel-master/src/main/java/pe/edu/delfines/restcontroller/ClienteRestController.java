...
public class ClienteRestController {
	...
	public ResponseEntity< Cliente> saveMedico(@RequestBody Cliente cliente) {
		try {
			Cliente newMedico = clienteService.save(cliente);
			return new ResponseEntity< Cliente >(newMedico, HttpStatus.CREATED);
		} catch (Exception e) {
	...
	@PutMapping(path = "/{id}", consumes = MediaType.APPLICATION_JSON_VALUE, 
			produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity< Cliente > updateMedico(@PathVariable("id") Integer id, 
